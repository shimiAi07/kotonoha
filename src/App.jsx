...
export default function App() {
  ...
  return (
    <div style={{ minHeight:"100%",background:"#EAF1F4",display:"flex",flexDirection:"column",alignItems:"center",fontFamily:"'Hiragino Kaku Gothic ProN','Noto Sans JP',sans-serif" }}>
